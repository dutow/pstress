...
function init_pg_tde_globally(sqlconn)
	...
	sqlconn:execute_query("SELECT pg_tde_set_server_principal_key('server-principal-key', 'reg_file');")
	sqlconn:execute_query("SELECT pg_tde_set_default_principal_key('def-principal-key', 'reg_file');")
